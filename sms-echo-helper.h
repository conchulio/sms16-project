 ...
 */
#ifndef SMS_ECHO_HELPER_H
#define SMS_ECHO_HELPER_H
 ...
 */
class SmsEchoClientHelper
{
public:
  /**
   * Create SmsEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  SmsEchoClientHelper (Address ip, uint16_t port);
   ...
   *
   * \param app Smart pointer to the application (real type must be SmsEchoClient).
